...
import progark.mygdx.game.controller.JoinGameController;
import progark.mygdx.game.main;
import progark.mygdx.game.manager.ViewStateManager;

public class JoinGameViewState extends BaseViewState {
    private JoinGameController controller;

    public JoinGameViewState(GameContext context) {
        super(context);
        this.controller = new JoinGameController(this, context);
